...
try:
    ...
    from translation.utils_mdm_to_amass.human_body_prior.src.human_body_prior.tools.model_loader import load_model
    from translation.utils_mdm_to_amass.human_body_prior.src.human_body_prior.tools.omni_tools import copy2cpu as c2c
    from translation.utils_mdm_to_amass.human_body_prior.src.human_body_prior.tools.omni_tools import log2file
    from translation.utils_mdm_to_amass.human_body_prior.src.human_body_prior.models.vposer_model import VPoser
    from translation.utils_mdm_to_amass.human_body_prior.src.human_body_prior.tools.omni_tools import flatten_list
...
class IK_Engine(nn.Module):
    ...
    def forward(self, source_kpts, target_kpts, initial_body_params={}):
        ...
        # print("CHANGE THE FREE VARS?? REMOVE BETAS, TRANS...")
        ...
        free_vars = {k: torch.nn.Parameter(v.detach(), requires_grad=True) for k,v in initial_body_params.items() if k in ['trans', 'poZ_body', 'root_orient']}
        static_vars = {
