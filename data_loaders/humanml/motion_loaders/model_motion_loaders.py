...
class MMGeneratedDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # to keep consistent with collate functions that return idx tensors
        return (motions, m_lens), item
...
def get_mdm_loader(
    ...
    # create a dataset of generated samples using the given model
