...
class CompTrainerV6(object):
    ...
    def train(self, train_dataset, val_dataset, plot_eval):
        ...
        while invalid:
            ...
            train_loader = DataLoader(train_dataset, batch_size=self.opt.batch_size, drop_last=True, num_workers=1,
                                      shuffle=True, collate_fn=collate_fn, pin_memory=True)
            val_loader = DataLoader(val_dataset, batch_size=self.opt.batch_size, drop_last=True, num_workers=1,
                                      shuffle=True, collate_fn=collate_fn, pin_memory=True)
