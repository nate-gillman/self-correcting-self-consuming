...
def evaluate_unconstrained_metrics(generated_motions, device, fast):
    ...
    iterator_generated = DataLoader(generated_motions, batch_size=64, shuffle=False, num_workers=1)
    ...
    iterator_dataset = DataLoader(motion_data, batch_size=64, shuffle=False, num_workers=1)
