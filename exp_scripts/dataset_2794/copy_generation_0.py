...
def copy_files(source_dir, target_dir):
    ...
    files_to_copy = ['model000200000.pt', 'opt000200000.pt', 'eval_dict.json', 'args.json']
...
def main():
    source_directory = 'exp_outputs/dataset_2794/generation_0/generation_0'

    # first, baseline
    target_directory = f'exp_outputs/dataset_2794/baseline/generation_0'
    copy_files(source_directory, target_directory)

    # then, iterative_finetuning experiments
    for augmentation_percentage in ["05", "10", "15", "20", "25"]:
        for experiment_type in ["iterative_finetuning", "iterative_finetuning_with_correction"]:
            target_directory = f'exp_outputs/dataset_2794/synthetic_percent_{augmentation_percentage}_{experiment_type}/generation_0'
            copy_files(source_directory, target_directory)
