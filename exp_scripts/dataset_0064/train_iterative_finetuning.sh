...
WANDB_PROJECT_NAME="dataset_0064"
WANDB_EXP_NAME="iterative_finetuning_${1}"

# if you run into GL issues, try deleting this line
export PYOPENGL_PLATFORM=''

# don't change these
MINI_DATASET_DIR="dataset/HumanML3D_subset_0064"
SAVE_DIR="exp_outputs/dataset_0064/synthetic_percent_${1}_iterative_finetuning"
