...
def copy_files(source_dir, target_dir):
    ...
    files_to_copy = ['model000020000.pt', 'opt000020000.pt', 'eval_dict.json', 'args.json']
...
def main():
    source_directory = 'exp_outputs/dataset_0256/generation_0/generation_0'

    # first, baseline
    target_directory = f'exp_outputs/dataset_0256/baseline/generation_0'
    ...
    for augmentation_percentage in ["025", "050", "075", "100"]:
        for experiment_type in ["iterative_finetuning", "iterative_finetuning_with_correction"]:
            target_directory = f'exp_outputs/dataset_0256/synthetic_percent_{augmentation_percentage}_{experiment_type}/generation_0'
            copy_files(source_directory, target_directory)
