...
sys.path.append(os.getcwd()+"/UniversalHumanoidControl")
...
def parse_args():
    ...
    parser.add_argument("--mode", type=str, default="vis") #(stats, vis, disp_stats)
    ...
    # nate added cuz removing this throws an error when gen data for POC
    parser.add_argument("--motions_dir", type=str, required=False, default="") 
    parser.add_argument("--remainder", type=int, required=False, default=0) 
    parser.add_argument("--modulus", type=int, required=False, default=1) 
