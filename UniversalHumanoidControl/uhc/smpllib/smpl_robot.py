...
try:
    ...
    from UniversalHumanoidControl.uhc.khrylib.mocap.skeleton import Skeleton
    from UniversalHumanoidControl.uhc.khrylib.mocap.skeleton_mesh import Skeleton as SkeletonMesh
    from UniversalHumanoidControl.uhc.khrylib.mocap.skeleton_mesh_v2 import Skeleton as SkeletonMeshV2
    from UniversalHumanoidControl.uhc.smpllib.smpl_parser import (
        SMPL_Parser,
        SMPLH_Parser,
        SMPLX_Parser,
    )
    from UniversalHumanoidControl.uhc.utils.geom import quadric_mesh_decimation, center_scale_mesh
...
class Robot:
    ...
    def __init__(self, cfg, data_dir="UniversalHumanoidControl/data/smpl", masterfoot=False):
        self.bodies = []
        self.weight = 0
        self.height = 0
        self.cfg = cfg
        ...
        if self.smpl_model == "smpl":
            self.smpl_parser_n = SMPL_Parser(model_path="UniversalHumanoidControl/data/smpl", gender="neutral")
            self.smpl_parser_m = SMPL_Parser(model_path="UniversalHumanoidControl/data/smpl", gender="male")
            self.smpl_parser_f = SMPL_Parser(model_path="UniversalHumanoidControl/data/smpl", gender="female")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # viewer.render()
        fname = os.path.join("outputs/smpl_robot", "cam-0000-%04d.png" % (control_steps))
        control_steps += 1
        img = sim.render(width, height)
