...
try:
    ...
    from UniversalHumanoidControl.uhc.utils.torch_utils import quaternion_matrix_batch
    from UniversalHumanoidControl.uhc.utils.flags import flags
    from UniversalHumanoidControl.uhc.utils.tools import get_expert, get_expert_master
    from UniversalHumanoidControl.uhc.khrylib.utils.transformation import quaternion_from_euler
    from UniversalHumanoidControl.uhc.khrylib.utils import *
    from UniversalHumanoidControl.uhc.khrylib.rl.envs.common import mujoco_env
    from UniversalHumanoidControl.uhc.utils.transformation import (
        quaternion_from_euler_batch,
        quaternion_multiply_batch,
        quat_mul_vec,
        quat_mul_vec_batch,
    ...
    from UniversalHumanoidControl.uhc.smpllib.smpl_mujoco import SMPLConverter
    from UniversalHumanoidControl.uhc.smpllib.torch_smpl_humanoid import Humanoid
    from UniversalHumanoidControl.uhc.smpllib.smpl_robot import Robot, in_hull
    from UniversalHumanoidControl.uhc.smpllib.smpl_mujoco import smpl_6d_to_qpose, smpl_to_qpose, qpos_to_smpl
    from UniversalHumanoidControl.uhc.smpllib.smpl_parser import (
        SMPL_EE_NAMES,
        SMPL_BONE_ORDER_NAMES,
        SMPLH_BONE_ORDER_NAMES,
    )
...
class HumanoidEnv(mujoco_env.MujocoEnv):
    ...
    def __init__(self, cfg, init_expert, data_specs, mode="train", no_root=False):
        ...
        self.smpl_robot_orig = Robot(cfg.robot_cfg, data_dir=osp.join(cfg.base_dir, "UniversalHumanoidControl/data/smpl"))
        self.smpl_robot = Robot(
            cfg.robot_cfg,
            data_dir=osp.join(cfg.base_dir, "UniversalHumanoidControl/data/smpl"),
        ...
        self.netural_path = osp.join("UniversalHumanoidControl", self.netural_path)
