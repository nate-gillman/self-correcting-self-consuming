...
try:
    ...
    from uhc.smpllib.smpl_parser import SMPLH_Parser, SMPL_Parser
    from uhc.utils.flags import flags
except:
    from UniversalHumanoidControl.uhc.utils.transform_utils import (
        convert_aa_to_orth6d,
        convert_orth_6d_to_aa,
        vertizalize_smpl_root,
        rotation_matrix_to_angle_axis,
    ...
    from UniversalHumanoidControl.uhc.smpllib.smpl_mujoco import smpl_to_qpose, SMPL_M_Viewer
    from UniversalHumanoidControl.uhc.utils.config_utils.copycat_config import Config
    from UniversalHumanoidControl.uhc.envs.humanoid_im import HumanoidEnv
    from UniversalHumanoidControl.uhc.utils.tools import get_expert
    from UniversalHumanoidControl.uhc.data_loaders.dataset_amass_single import DatasetAMASSSingle
    from UniversalHumanoidControl.uhc.smpllib.smpl_parser import SMPLH_Parser, SMPL_Parser
...
amass_splits = {
    ...
    'train': ['CMU', 'MPI_Limits', 'TotalCapture', 'Eyes_Japan_Dataset', 'KIT', 'BML', 'EKUT',
              'TCD_handMocap', "BMLhandball", "DanceDB", "ACCAD", "BMLmovi", "BioMotionLab", "Eyes", "DFaust"]
    # Adding ACCAD
}
...
if __name__ == "__main__":
    ...
    with contextlib.redirect_stdout(None):
        # suppress warnings about 10 betas
        smpl_parser_n = SMPLH_Parser(model_path="data/smpl", gender="neutral", use_pca=False,
                                     create_transl=False)
        smpl_parser_m = SMPLH_Parser(model_path="data/smpl", gender="male", use_pca=False,
                                     create_transl=False)
        smpl_parser_f = SMPLH_Parser(model_path="data/smpl", gender="female", use_pca=False,
                                     create_transl=False)
